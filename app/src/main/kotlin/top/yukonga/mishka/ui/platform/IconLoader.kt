...
import top.yukonga.mishka.ui.platform.IconLoader.FAILURE_RETRY_INTERVAL
import top.yukonga.mishka.ui.platform.IconLoader.setProxyResolver
...
/** 将图标字节解码为 [ImageBitmap]；解码失败抛异常，由调用方 runCatching 兜底。 */
